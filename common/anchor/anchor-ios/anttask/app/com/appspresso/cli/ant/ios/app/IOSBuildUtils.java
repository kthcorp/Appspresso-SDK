...
public class IOSBuildUtils {
	private static final String FORMAT_IOS_PROPERTY_EXPR = "axplugin/module[@platform='ios']/property[@name='%s']";

	private final static Map<String, XPathExpression> xpathExpressions = new HashMap<String, XPathExpression>(2);
	...
	private static XPathExpression getExpr(String propertyName) throws XPathExpressionException {
		...
		if ((xpathExpr = xpathExpressions.get(propertyName)) == null) {
			String expression = String.format(FORMAT_IOS_PROPERTY_EXPR, propertyName);
