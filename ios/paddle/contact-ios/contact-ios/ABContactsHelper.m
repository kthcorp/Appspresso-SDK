...
{
	NSPredicate *pred;
	NSArray *contacts = (nil == target) ? [ABContactsHelper contacts] : target;
	pred = [NSPredicate predicateWithFormat:@"firstname LIKE[cd] %@ ", firstName];
	return [contacts filteredArrayUsingPredicate:pred];
}
...
+ (NSArray *)contactsMatchingLastName:(NSString *)lastName withArray:(NSArray *)target
{
	NSPredicate *pred;
	NSArray *contacts = (nil == target) ? [ABContactsHelper contacts] : target;
	pred = [NSPredicate predicateWithFormat:@"lastname LIKE[cd] %@ ", lastName];
	return [contacts filteredArrayUsingPredicate:pred];
}

// Matching firstPhoneticName
+ (NSArray *)contactsMatchingPhoneticFirstName:(NSString *)firstPhoneticName withArray:(NSArray *)target
{
	NSPredicate *pred;
	NSArray *contacts = (nil == target) ? [ABContactsHelper contacts] : target;
	pred = [NSPredicate predicateWithFormat:@"firstnamephonetic LIKE[cd] %@ ",firstPhoneticName];
	return [contacts filteredArrayUsingPredicate:pred];
}
...
+ (NSArray *)contactsMatchingNickName:(NSString *)nickName withArray:(NSArray *)target
{
	NSPredicate *pred;
	NSArray *contacts = (nil == target) ? [ABContactsHelper contacts] : target;
	pred = [NSPredicate predicateWithFormat:@"nickname LIKE[cd] %@ ", nickName];
	return [contacts filteredArrayUsingPredicate:pred];
}
...
+ (NSArray *)contactsMatchingPhoneNumber:(NSString *)phoneNumber withArray:(NSArray *)target {
	NSPredicate *pred;
	NSArray *contacts = (nil == target) ? [ABContactsHelper contacts] : target;
	pred = [NSPredicate predicateWithFormat:@"phonenumbers LIKE[cd] %@ ", phoneNumber];
	return [contacts filteredArrayUsingPredicate:pred];	
}
...
+ (NSArray *)contactsMatchingEmails:(NSString *)emails withArray:(NSArray *)target {
	NSPredicate *pred;
	NSArray *contacts = (nil == target) ? [ABContactsHelper contacts] : target;
	pred = [NSPredicate predicateWithFormat:@"emailaddresses LIKE[cd] %@ ", emails];
	return [contacts filteredArrayUsingPredicate:pred];		
}
...
+ (NSArray *)contactsMatchingAddress:(NSString *)address withArray:(NSArray *)target {
	NSPredicate *pred;
	NSArray *contacts = (nil == target) ? [ABContactsHelper contacts] : target;
	pred = [NSPredicate predicateWithFormat:@"addresses LIKE[cd] %@ ", address];
	return [contacts filteredArrayUsingPredicate:pred];
}
@end